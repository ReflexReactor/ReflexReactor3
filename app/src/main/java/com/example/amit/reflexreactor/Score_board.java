  ...
  //  int isAccepted=0;
    ...
    class DeleteGame extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            {
                pDialog=new ProgressDialog(Score_board.this);
    ...
    {
        Intent intent=new Intent(Score_board.this,MainActivity.class);
    ...
    class Send_Game_Request extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            tmp1="";
            tmp2="";
            Table_number=new int[6];
            Question_number=new int[6];
            for(int i=0;i<6;i++)
            {
    ...
    {
        connection=false;
        Intent intent=new Intent(Score_board.this,InternetActivity.class);
